...
```
<br>
VLAN на бридже (поведение исходящего(наружу) трафика)<br>
```
Bridge => Bridge => VLANs => [+]
```
![](./img/vlan_bridge_vlans.PNG)   <br>
Bridge: - На каком бридже настраиваем (ихможет быть более одного) <br>
VLAN IDs: - каой VLAN настраиваем. <br>
Targged: - на этих интерфейсах маркеруем трафик (навешиваем VLAN). <br>
Untargged: - на этих интерфейсах снимаем метку с трафика (снимаем VLAN). <br>
#### Fork + Git
